...
|--------|------------------|
| Person 1 | Team lead — CI/SonarCloud, architecture/integration review, project setup, final merge support |
...
| Person 5 | Native Android app and final QA/support evidence |
